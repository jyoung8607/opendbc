...
def create_acc_accel_control(packer, bus, acc_type, acc_enabled, accel, acc_control, stopping, starting, esp_hold):
  ...
  acc_06_values = {
    ...
    "ACC_zul_Regelabw_unten": 0.05,  # TODO: see if actual zero works, would ideally adjust on allowThrottle/allowBrake
    "ACC_zul_Regelabw_oben": 0.05,  # TODO: same as above
