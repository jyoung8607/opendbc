  ...
  {% for sig in sigs %}
    {
      ...
      {% elif checksum_type == "stellantis" and sig.name == "CHECKSUM" %}
      .type = SignalType::STELLANTIS_CHECKSUM,
      {% elif checksum_type == "stellantis" and sig.name == "COUNTER" %}
      .type = SignalType::STELLANTIS_COUNTER,
